...
const s_stylePath = '/modules/comment-widget/comment-widget.css';
const s_formId = '1FAIpQLScXoh1N3kGM3kATVCjjPTYTw6zL8CKSDopy3U6o4rctHyCpCQ';
const s_nameId = '1669859939';
const s_websiteId = '1718374664';
const s_textId = '1937850653';
const s_pageId = '883010159';
const s_replyId = '203066449';
const s_sheetId = '1s4uDvhTid7uC66ZpgHAMKjALKun4Kn6OFTJ8TTjjsls';

// The values below are necessary for accurate timestamps
const s_timezone = 1; // Your personal timezone (Example: UTC-5:00 is -5, UTC+10:30 would be 10.5)
...
const s_dstStart = ['March', 'Sunday', 4, 1]; // Example shown is the last Sunday of March at 1:00 am
const s_dstEnd = ['November', 'Sunday', 4, 2]; // Example shown is the last Sunday of Ostober at 2:00 am

// Misc - Other random settings
const s_commentsPerPage = 1; // The max amount of comments that can be displayed on one page, any number >= 1 (Replies not counted)
...
const s_loadingText = '<span style=\"color:#ff4f1a\">Loading comments...<\span>';
const s_noCommentsText = '<span style=\"color:#ff4f1a\">No messages :(<\span>';
const s_closedCommentsText = '<span style=\"color:#ff4f1a\">Guestbook closed temporarily<\span>';
